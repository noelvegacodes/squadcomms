...
<form method="POST" use:enhance class="border-2 max-w-2xl mx-auto p-10 rounded-lg mt-20">
	...
	<div class="flex flex-col gap-4">
		...
		<button class="bg-green-600 w-full py-2 text-white font-semibold rounded-full"> Login </button>

		<div>
			<p class="text-sm">
				Forget your password? <a href="/password-forget" class="text-blue-500 hover:underline">
					Reset password</a
				>
			</p>
		</div>
